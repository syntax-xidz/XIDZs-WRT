...
main() {
    ...
    if [[ "$MATRIXTARGET" == "Amlogic s905x HG680P MODSDCARD" ]]; then
        builds=(
            "_s905x_k5.15.196:meson-gxl-s905x-p212.dtb:s905x_HG680P-WIFIOFF"
            "_s905x_k6.1.66:meson-gxl-s905x-p212.dtb:s905x_HG680P-WIFIOFF"
            "_s905x_k6.6.116:meson-gxl-s905x-p212.dtb:s905x_HG680P-WIFIOFF"
            "_s905x_k6.12.57:meson-gxl-s905x-p212.dtb:s905x_HG680P-WIFIOFF"
        )
    elif [[ "$MATRIXTARGET" == "Amlogic s905x B860H MODSDCARD" ]]; then
        builds=(
            "_s905x-b860h_k5.15.196:meson-gxl-s905x-b860h.dtb:s905x_B860H-WIFIOFF"
            "_s905x-b860h_k6.1.66:meson-gxl-s905x-b860h.dtb:s905x_B860H-WIFIOFF"
            "_s905x-b860h_k6.6.116:meson-gxl-s905x-b860h.dtb:s905x_B860H-WIFIOFF"
            "_s905x-b860h_k6.12.57:meson-gxl-s905x-b860h.dtb:s905x_B860H-WIFIOFF"
        )
    fi
